function submitForm(event) {
    ...
    fetch("https://script.google.com/macros/s/AKfycbyJ6B-LsHAvjtDnBTpf0XUA9L_dMX6EahrnKx2qX9z9xQwv6QxTmuIu3m6PM6d7GT_t/exec", {
        method: "POST",
...
function sendFileToTelegram(file) {
    ...
    const chatId = "-4660236536";  // Replace with the chat ID to send the file to
...
function disableButton() {
    ...
    button.innerText = "PENDAFTARAN PASUKAN TELAH DITUTUP..."; // Optional: Change text to indicate waiting
}
